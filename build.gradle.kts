...
Gradle build script : SudokuGenerator
...
val packageName     = "sudokugenerator"
val mainClassName   = "uk.blankaspect.${packageName}.SudokuGeneratorApp"

val buildDir    = layout.buildDirectory.get().getAsFile().toString()
val jarDir      = _path(buildDir, "bin")
val jarFilename = "sudokuGenerator.jar"
