### blankaspect/sudokuGenerator

This repository contains the source code and resources of the SudokuGenerator application.  The repo conforms to the
...
You can find more information about SudokuGenerator on the project's
[home page](https://blankaspect.github.io/sudokuGenerator/).
...
SudokuGenerator is a non-modular JavaFX application.  The `compileJava`, `jar`, `runMain` and `runJar` tasks expect the
...
* You may use the contents of the `uk.blankaspect.sudokugenerator` package \(including resources\) under the terms and
